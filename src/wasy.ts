...
export class Wasy {
	...
	get instruments() { return this.engine.instruments; }
	get gain() { return this.engine.gain; }
	get dynamicsCompressor() { return this.engine.dynamicsCompressor; }
	get timer() { return this.player.timer; }
	get playerWorker() { return this.player.playerWorker; }
